...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 8, 0, 
		...
		XYREF(Button_MinusMinus, 260, 183),
		XYREF(Button_PlusPlus, 63, 183),
		XYREF(Rectangle_14001, 403, 116),
	...
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(80), WORD(80), 118, 12, 1, 0, 1, 0, 
	...
	ID(Button_MinusMinus), TYPEID_BUTTON, WORD(80), WORD(80), 120, 12, 1, 0, 1, 0, 
	...
	ID(Rectangle_14001), TYPEID_OUTRECT, ID(LineAttributes_Border), 
		WORD(64), WORD(63), 0, ID(FillAttributes_DarkerBG), 0, 
	...
	ID(ColorMap_34001), TYPEID_COLMAP, WORD(256), 
		...
		COLOR(224), COLOR(225), COLOR_YELLOW, COLOR(227), COLOR(228), COLOR(229), COLOR(230), COLOR_WHITE, COLOR(232), COLOR(233), COLOR(234), COLOR(235), COLOR(236), COLOR(237), COLOR(238), COLOR(239), 
		COLOR(240), COLOR(241), COLOR(242), COLOR(243), COLOR(244), COLOR(245), COLOR(246), COLOR(247), COLOR(248), COLOR(249), COLOR(250), COLOR(251), COLOR(252), COLOR(253), COLOR(254), COLOR(255), 
	ID(ColorMap_34002), TYPEID_COLMAP, WORD(256), 
		COLOR_BLACK, COLOR_WHITE, COLOR_GREEN, COLOR_TEAL, COLOR_MAROON, COLOR_PURPLE, COLOR_OLIVE, COLOR_SILVER, COLOR_GREY, COLOR_BLUE, COLOR_LIME, COLOR_CYAN, COLOR_RED, COLOR_MAGENTA, COLOR_YELLOW, COLOR_NAVY, 
		COLOR_BLACK, COLOR(17), COLOR(18), COLOR_NAVY, COLOR(20), COLOR_BLUE, COLOR(22), COLOR(23), COLOR(24), COLOR(25), COLOR(26), COLOR(27), COLOR(28), COLOR(29), COLOR(30), COLOR(31), 
		COLOR(32), COLOR(33), COLOR_GREEN, COLOR(35), COLOR(36), COLOR_TEAL, COLOR(38), COLOR(39), COLOR(40), COLOR(41), COLOR(42), COLOR(43), COLOR(44), COLOR(45), COLOR_LIME, COLOR(47), 
		COLOR(48), COLOR(49), COLOR(50), COLOR_CYAN, COLOR(52), COLOR(53), COLOR(54), COLOR(55), COLOR(56), COLOR(57), COLOR(58), COLOR(59), COLOR(60), COLOR(61), COLOR(62), COLOR(63), 
		...
		COLOR(224), COLOR(225), COLOR_YELLOW, COLOR(227), COLOR(228), COLOR(229), COLOR(230), COLOR_WHITE, COLOR(232), COLOR(233), COLOR(234), COLOR(235), COLOR(236), COLOR(237), COLOR(238), COLOR(239), 
		COLOR(240), COLOR(241), COLOR(242), COLOR(243), COLOR(244), COLOR(245), COLOR(246), COLOR(247), COLOR(248), COLOR(249), COLOR(250), COLOR(251), COLOR(252), COLOR(253), COLOR(254), COLOR(255), 
	ID(ColorMap_34003), TYPEID_COLMAP, WORD(256), 
		COLOR_BLACK, COLOR_WHITE, COLOR_GREEN, COLOR_TEAL, COLOR_MAROON, COLOR_PURPLE, COLOR_OLIVE, COLOR_SILVER, COLOR_GREY, COLOR_BLUE, COLOR_LIME, COLOR_CYAN, COLOR_RED, COLOR_MAGENTA, COLOR_YELLOW, COLOR_NAVY, 
		COLOR_BLACK, COLOR(17), COLOR(18), COLOR_NAVY, COLOR(20), COLOR_BLUE, COLOR(22), COLOR(23), COLOR(24), COLOR(25), COLOR(26), COLOR(27), COLOR(28), COLOR(29), COLOR(30), COLOR(31), 
		COLOR(32), COLOR(33), COLOR_GREEN, COLOR(35), COLOR(36), COLOR_TEAL, COLOR(38), COLOR(39), COLOR(40), COLOR(41), COLOR(42), COLOR(43), COLOR(44), COLOR(45), COLOR_LIME, COLOR(47), 
		COLOR(48), COLOR(49), COLOR(50), COLOR_CYAN, COLOR(52), COLOR(53), COLOR(54), COLOR(55), COLOR(56), COLOR(57), COLOR(58), COLOR(59), COLOR(60), COLOR(61), COLOR(62), COLOR(63), 
